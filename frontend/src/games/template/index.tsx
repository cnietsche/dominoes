...
function GameTemplateLobby({ displayName, onExit }: GameModuleProps) {
...
const gameTemplateModule: GameModule = {
  Component: GameTemplateLobby,
};

export default gameTemplateModule;
