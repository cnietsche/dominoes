...
import (
	...
	"github.com/dominoes/rock-paper-scissors-api/internal/config"
	"github.com/dominoes/rock-paper-scissors-api/internal/handler"
	"github.com/dominoes/rock-paper-scissors-api/internal/presence"
	"github.com/dominoes/rock-paper-scissors-api/internal/repository"
	"github.com/dominoes/rock-paper-scissors-api/internal/service"
...
func main() {
	...
	addr := ":" + cfg.Port
	log.Printf("Rock Paper Scissors lobby server listening on %s", addr)
